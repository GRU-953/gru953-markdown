...
[![Tests](https://img.shields.io/badge/tests-138%20passing-brightgreen?style=flat-square)](https://github.com/GRU-953/markitdown-converter/actions/workflows/ci.yml)
...
**138 tests** across all five logic modules. CI runs them on every push
